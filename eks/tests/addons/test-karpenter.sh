...
test_version_flag() {
    log_test "KARP-002: --version flag"
...
test_cluster_flag() {
    log_test "KARP-003: --cluster flag"
...
test_dry_run() {
    log_test "KARP-004: --dry-run flag"
...
test_invalid_flag() {
    log_test "KARP-005: Invalid flag handling"
