...
export NODEGROUP_FILE="$PWD/versions/$(echo "$CLUSTER_FILE_LOCATION")/${EKS_CLUSTER_NAME}-${EKS_CLUSTER_REGION}-self-managed-nodegroup-${NODEGROUP_CONFIG}-${INSTANCE_TYPE}.yaml"
