...
log_info "Enabling Azure Disk CSI driver on AKS..."
run_cmd "az aks update --name $CLUSTER --resource-group $RESOURCE_GROUP --enable-disk-driver"
log_info "Azure Disk CSI driver enabled!"
