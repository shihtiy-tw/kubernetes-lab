#!/usr/bin/env bash
set -euo pipefail
VERSION="1.0.0"; NAMESPACE="external-dns"; RELEASE_NAME="external-dns"; CHART_VERSION=""; DRY_RUN=false
...
run_cmd "helm repo add external-dns https://kubernetes-sigs.github.io/external-dns/ --force-update"
run_cmd "helm repo update external-dns"
log_info "Installing external-dns..."
cmd="helm upgrade --install $RELEASE_NAME external-dns/external-dns -n $NAMESPACE --create-namespace"
